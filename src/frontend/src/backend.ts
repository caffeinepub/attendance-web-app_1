...
export class Backend implements backendInterface {
    ...
    async deleteAttendance(arg0: bigint): Promise<{
        __kind__: "ok";
        ok: null;
    } | {
        __kind__: "err";
    ...
    async deleteEmployee(arg0: string): Promise<{
        __kind__: "ok";
        ok: null;
    } | {
        __kind__: "err";
    ...
    async getAppsScriptUrl(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getAppsScriptUrl();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAttendanceByMobile(arg0: string): Promise<Array<AttendanceRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAttendanceByMobile(arg0);
                return from_candid_vec_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setAppsScriptUrl(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setAppsScriptUrl(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAttendance(arg0: bigint, arg1: AttendanceInput): Promise<{
        __kind__: "ok";
        ok: null;
    } | {
        __kind__: "err";
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "exit" in value ? LogType.exit : "entry" in value ? LogType.entry : value;
}
